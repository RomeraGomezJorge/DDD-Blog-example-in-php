<?php
	...
	class AuthorGetController extends WebController
	{
		public function __invoke(
			Request $request,
			AuthorsByCriteriaSearcher $itemsByCriteriaSearcher,
			AuthorByCriteriaCounter $counter
		): Response {
			...
			$authors = $itemsByCriteriaSearcher->__invoke($filters, $order, $orderBy, $limit,
