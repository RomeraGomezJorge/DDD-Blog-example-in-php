<?php
	...
	final class ArticleByCriteriaCounter
	{
		private ArticleRepository $repository;
		private FilterUtilsForArticle $filterUtils;
		
		public function __construct(ArticleRepository $repository, FilterUtilsForArticle $filterUtils)
		{
		...
		public function __invoke($filters, $order, $orderBy, ?int $limit, ?int $offset): int
		{
			...
			return $this->repository->totalMatchingRows($criteria, $category);
		}
	}