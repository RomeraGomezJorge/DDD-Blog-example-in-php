<?php
	...
	use App\Backoffice\Article\Application\Delete\ArticleDeleter;
	...
	class ArticleDeleteController extends WebController
	{
		public function __invoke(Request $request, ArticleDeleter $deleter): JsonResponse
		{
		...
		private function delete(ArticleDeleter $deleter, string $id): array
		{
			$deleter->__invoke($id);
