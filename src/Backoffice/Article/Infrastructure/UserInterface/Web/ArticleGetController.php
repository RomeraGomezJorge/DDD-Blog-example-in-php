<?php
	...
	use App\Backoffice\Article\Application\Get\Collection\ArticleByCriteriaCounter;
	use App\Backoffice\Article\Application\Get\Collection\ArticlesByCriteriaSearcher;
	...
	class ArticleGetController extends WebController
	{
		public function __invoke(
			Request $request,
			ArticlesByCriteriaSearcher $itemsByCriteriaSearcher,
			ArticleByCriteriaCounter $counter,
			...
			$articles = $itemsByCriteriaSearcher->__invoke(
				$filters,
				$order,
				$orderBy,
				$limit,
